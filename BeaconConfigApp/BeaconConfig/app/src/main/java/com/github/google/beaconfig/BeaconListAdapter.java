...
public class BeaconListAdapter extends RecyclerView.Adapter<BeaconListAdapter.ViewHolder> {
    ...
    static private Activity mAppActivity;

    public BeaconListAdapter(List<BeaconScanData> scanDataList, Context context, Activity activity) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public static final String BEACON_NUMBER = "com.bluetooth.beaconconfig.BEACON_NUMBER";
        public static final String CONFIG_FILE_PATH = "com.bluetooth.beaconconfig.CONFIG_FILE_PATH";
        ...
        public ViewHolder(View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String configFilePath = ((ScanningActivity)mAppActivity).getFilePath();
                    if(configFilePath != null) {
                        int beaconNo = ((ScanningActivity) mAppActivity).getAmountOfProgrammedBeacon();
                        //Context context = getApplicationContext();
                        //BeaconListAdapter.this.context.getSharedPreferences( "com.example.myapp.PREFERENCE_FILE_KEY" , Context.MODE_PRIVATE);
                        //SharedPreferences sharedPref = context.getSharedPreferences( "com.example.myapp.PREFERENCE_FILE_KEY" , Context.MODE_PRIVATE);
                        //int beaconNo = sharedPref.getInt("com.github.google.beaconfig.AmountOfProgrammedBeacons",1);


                        Intent configBeacon =
                                new Intent(cardView.getContext(), BeaconAutoConfigActivity.class);
                        configBeacon.putExtra(BEACON_ADDRESS, address.getText());
                        configBeacon.putExtra(BEACON_NAME, name.getText());
                        configBeacon.putExtra(BEACON_NUMBER, beaconNo);
                        configBeacon.putExtra(CONFIG_FILE_PATH, configFilePath);
                        ((Activity)cardView.getContext()).startActivityForResult(configBeacon, Constants.REQUEST_PROGRAM_BEACON);
                        //cardView.getContext().startActivity(configBeacon);
                    }else{
                        Toast.makeText(mAppActivity.getApplicationContext(),
