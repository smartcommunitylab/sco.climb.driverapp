angular.module('driverapp.services.storage', [])
    ...
    .factory('StorageSrv', function ($q) {
        ...
        storageService.saveIdentity = function (identity) {
        ...
        storageService.getIdentity = function () {
            if (!!localStorage[KEYS.IDENTITY]) {
                return localStorage[KEYS.IDENTITY];
            }
            return null;
        };

        storageService.clearIdentity = function () {
        ...
        storageService.setOwnerId = function (ownerId) {
            localStorage[KEYS.OWNERID] = ownerId;

        }
        storageService.getOwnerId= function(){
                if (!!localStorage[KEYS.OWNERID]) {
                return localStorage[KEYS.OWNERID];
            }
            return null;
        }
