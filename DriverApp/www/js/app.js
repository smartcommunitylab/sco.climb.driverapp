angular.module('driverapp', [
  ...
  .run(function ($ionicPlatform, $rootScope, $state, $translate, $ionicHistory, $ionicPopup,$ionicModal,  $window, GeoSrv, Config, Utils, StorageSrv, WSNSrv, APISrv, LoginService) {
