...
.controller('WizardCtrl', function ($scope, $rootScope, $state, $window, $ionicPopup, $ionicPlatform, $ionicModal, $ionicHistory, $ionicSlideBoxDelegate, $timeout, $filter, Config, Utils, StorageSrv, APISrv, WSNSrv) {
